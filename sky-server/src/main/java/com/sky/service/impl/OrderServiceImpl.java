...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderStatisticsVO statistics() {
        ...
        return OrderStatisticsVO.builder()
                .deliveryInProgress(getCountByStatus(Orders.DELIVERY_IN_PROGRESS))
                .confirmed(getCountByStatus(Orders.CONFIRMED))
                .toBeConfirmed(getCountByStatus(Orders.TO_BE_CONFIRMED))
                .build();
    }
